  ...
  return (
    <div className="daContainer">
      <div className="da1">
        <div className="da11">
          <div className="hero-text">
            ...
            <p>
              -Build data analysis skills and master statistical techniques
      ...
      <div className="da4">
        ...
        <p>
          Data analytics is the backbone of modern enterprises, fueling
          breakthrough insights, informed decisions, and exponential growth.
        </p>
        <div className="da4-card">
          <div className="card" style={{ width: "18rem" }}>
            <div className="card-body">
              <p className="card-text">
                By 2025, India is expected to have 13,630 new data analytics
          ...
          <div className="da4-card">
            <div className="card" style={{ width: "18rem" }}>
              <div className="card-body">
                <p className="card-text">
                  The Indian data analytics market is projected to reach 80%
                 by 2028, indicating rapid growth.
                </p>
                <h1 className="card-title">80%</h1>

                <p>Source: Data Analytics Insight</p>
              </div>
            </div>
          </div>
        </div>
